...
import { ListTodo, AlertTriangle, MessageSquare, CheckCircle2, Clock } from "lucide-react";
              ...
              <tbody>
                {tableRows.map((row) => (
                  <tr key={row.name} className="border-b border-border/20 hover:bg-secondary/20 transition-colors">
                    ...
                    <td className="text-center py-3 px-4">
                      <span className="inline-block min-w-[2rem] px-2 py-0.5 rounded-lg bg-orange-400/10 text-orange-400 font-semibold">{row.commentPending}</span>
                    </td>
                    <td className="text-center py-3 px-4">
                ...
                {selectedProject === "ALL" && tableRows.length > 1 && (
                  <tr className="border-t-2 border-border/50 bg-secondary/10">
                    ...
                    <td className="text-center py-3 px-4">
                      <span className="inline-block min-w-[2rem] px-2 py-0.5 rounded-lg bg-orange-400/10 text-orange-400 font-bold">{totals.commentPending}</span>
                    </td>
                    <td className="text-center py-3 px-4">
